export default{
    ...
    LogoColorpalleteTitle:'Choose Your Color Palette',
    LogoColorPalleteDesc:'Pick the colors that reflect your brands personality and create a lasting impression.',
